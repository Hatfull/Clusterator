...
def getblastrecords(InputFile): 
	...
	blastn_cline = NcbiblastnCommandline(query=InputFile, db="mycobacteriophages599", evalue=10, outfmt=5, out=OutputFile)#, gapopen=4, gapextend=1, reward=1, penalty=-1)
